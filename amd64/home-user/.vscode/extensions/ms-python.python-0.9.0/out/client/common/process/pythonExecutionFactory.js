    ...
    create(resource) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return this.envVarsService.getEnvironmentVariables(true, resource)
                .then(customEnvVars => {
                return new pythonProcess_1.PythonExecutionService(this.procService, settings.pythonPath, customEnvVars);
            });
        });
    }
};
PythonExecutionFactory = __decorate([
    ...
    __param(0, inversify_1.inject(types_2.IProcessService)),
    __param(1, inversify_1.inject(types_1.IEnvironmentVariablesProvider))
