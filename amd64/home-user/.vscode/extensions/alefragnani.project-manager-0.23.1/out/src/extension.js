...
function activate(context) {
    ...
    // tree-view
    const projectProvider = new ProjectProvider_1.ProjectProvider(projectStorage, [vscLocator, gitLocator, svnLocator], context);
    ...
    function refreshProjects(showMessage, forceProviderRefresh) {
